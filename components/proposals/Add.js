...
export default function Add({ path }) {
  ...
  return (
    <Link
      href={pathname + path}
      className="bg-green-400 hover:bg-[#00fa8e] fixed bottom-8 right-8 rounded-full size-16 sm:size-fit flex items-center justify-center p-2 sm:px-4 cursor-pointer"
